# Code is heavily inspired by Phil Tabor's code and his youtube tutorial. Please check out
# his work at github.com/philtabor/Youtube-Code-Repository/blob/master/ReinforcementLearning/PolicyGradient/DDPG/pytorch/lunar-lander/ddpg_torch.py


"""
Created on Wed May  3 01:00:39 2022
...
class CriticNN(nn.Module):
    ...
    def __init__(self, LR, input_dims, fc1_dims, fc2_dims, name):
        ...
        self.checkpoint_file = os.path.join('./',name+'_ddpg')
        self.to(self.device)
