...
def episodes_50_return(agent, S, K, T, sigma, r):
    scores = []
    for i in range(50):
        env = HedgingEnv(S, K, T, sigma, r)
        done = False
        score = 0
        state = [S, T]
        while not done:
...
def episodes_50_return_DQN(agent, S, K, T, sigma, r):
    scores = []
    for i in range(50):
        env = HedgingEnv_DQN(S, K, T, sigma, r)
        done = False
        score = 0
        state = [S, T]
        while not done:
