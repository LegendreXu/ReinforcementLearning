...
os.chdir('C:/Users/13732/ReinforcementLearning/MAB/dataset')
import pickle
...
for key in data.keys():
    data[key] = data[key].rename(columns = {'Open':'open', 'High':'high', 'Low':'low', 'Close':'close'})
with open('EU_data.pickle', 'wb') as handle:
